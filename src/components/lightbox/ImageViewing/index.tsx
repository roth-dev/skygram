...
import { Dimensions, ImageSource, Transform } from "./@types";
    ...
    >
      <SafeAreaView edges={["bottom"]}>
        ...
        <View style={styles.footerBtns}>
          ...
          >
            <Button.Icon name="folder" color={"#fff"} size={16} />
          ...
          >
            <Button.Icon name="shareplay" color="#fff" size={16} />
            <Text font="semiBold" className="text-white">
              Share
            </Text>
          </Button>
        </View>
